...
#  print(res+bwh+'WS -'+res+bgrn+str( total_wins)+ '|'+ res+bwh+'LS -'+ res+bred+str(total_loses)+ '|' ,res+bwh+'Profit :',clr+str( prof)+res,'|', '|', res+lblk4+' Total Bet :',str(bet_no ) +res)
 ...
 # print(chang_los)
  ...
  rnm=random.randint(1,4)
  rnm2=random.randint(1,10)
  rnm3=random.randint(1,7)
  if chance==97 and no_lose>=1:
        hunt= True
        mull= True
  else:
        pass
  ...
  if rnm==1 and hunt and not mk:
        chance=33 #chance-random.randint(1,2)
 ...
 #      bb=float(format(bb1, '.8f'))
  ...
  elif rnm==3 and hunt and not mk:
        chance=10
        mul=random.uniform(0.8,1.42)
        bb1=(bb * mul)
#       bb=float(format(bb1, '.8f'))

  elif rnm==4 and hunt and not mk:
        chance=random.randint(5,7)
        mul=random.uniform(1,1.2)
        bb1=(bb * mul)
  else:
        pass
  ...
  if betno3%random.randint(3,5)==0 and hunt and not mk :
        mll=random.uniform(1.15,1.21)
        bb1=(bb * mll)
        bb=float(format(bb1, '.8f'))
  else:
        pass

  if betno3%random.randint(1,2)==0 and hunt and mk:
        mll=random.uniform(1.15,1.25)
        bb1=(bb * mll)
        bb=float(format(bb1, '.8f'))
        chance=random.randint(5,9)
  else:
        pass

  if wnt and mk and crp>=-0.0008:
        mll=random.uniform(1.15,1.2)
        bb1=(bb * mll)
  ...
  if crp>=0.0000000 and mk:
        mll=random.uniform(1.15,1.2)
        mk=False
        bb=0.000001 #float(format(bb1, '.8f'))
  else:
        pass

  if wnt and crp<=-random.uniform(0.0008,0.001):
        mul=random.uniform(0.00000001,0.0000001)
        mk=True
        bb=0.000001 #float(format(bb/random.uniform(1.5,2),'.8f'))
        if hl=='h':
                hl='l'
        else:
                hl='h'
 ...
 #######PROFIT RESET#######
  ...
  if crp >=0.00000001:
        ...
        bb1=round(bb, 8)
        bb=float(format(bb1, '.8f'))
        chance= 97 #random.randint(93,96)
  ...
  sys.stdout.write(res+'  ' +res+bmag+str(crnc)+res+' | '+' '+bgrn+' Wagered :'+res+bwh+ str(fnl_wg) +res+res+bcy+' ' +'Bet: '+str(bet_no)+' ' +res+' '+"\r")
